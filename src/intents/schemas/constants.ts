import { BlockState,  NonceState, PriceOperator, RunsType, SegmentFunctionNameValues, SignatureType, TokenStandard } from "@brinkninja/types"
...
export const segmentFunctionNames = Object.keys(SegmentFunctionNameValues).filter(key => isNaN(Number(key)));
