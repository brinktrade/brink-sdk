...
describe('Utils', () => {
  ...
  describe('convertToX96HexPrice', () => {
    ...
    it('should convert 200/100 correctly', () => {
      const result = convertToX96HexPrice(200, 100);
    ...
    it('should convert 300/100 correctly', () => {
      const result = convertToX96HexPrice(300, 100);
    ...
    it('should convert 1/1 correctly', () => {
      const result = convertToX96HexPrice(1, 1);
    ...
    it('should convert 200/1 correctly', () => {
      const result = convertToX96HexPrice(200, 1);
    ...
    it('should handle big numbers correctly', () => {
      const bigNumber = 10**12; // a trillion
      const result = convertToX96HexPrice(bigNumber, 1);
    ...
    it('should throw error for division by zero', () => {
      expect(() => convertToX96HexPrice(200, 0)).to.throw("Division by zero");
    });
  });
